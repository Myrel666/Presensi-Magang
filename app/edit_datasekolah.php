    ...
    <div class="wrapper">
        ...
        <section class="content">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="get" action="edit/edit_sekolah.php">
                <?php //var_dump($view) ?> 
                <div class="card-body">
                ...
                <div>
                <input type="text" class="form-control"  placeholder="Nama Lengkap" name='nama_sekolah' value="<?php echo $view['nama_sekolah']?>">

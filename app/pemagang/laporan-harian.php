              ...
              <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal-default">
                ...
                <table id="example1" class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $query = mysqli_query ($koneksi, "SELECT * FROM tb_laporan_harian WHERE id_pemagang='{$_SESSION['id_pemagang']}'");
                  ...
                  <tr>
                    ...
                    <!-- <td><span  class="badge bg <?= $row ['status'] == 'proses' ? 'badge bg-warning' : 'badge bg-success'; ?>"><?php echo $row ['status'];?></td> -->
                    ...
                    <td>
                      <a href="../delete/hapus_data.php?method=laporan_delete&id=<?php echo $row ['id'];?>" onclick="return confirm('Data Akan Dihapus ?')" class="btn btn-sm btn-outline-danger"> Hapus </a>
                      
                      <a href= "detail_laporan-harian.php?id=<?= $row['id']; ?>" class="btn btn-sm btn-outline-info">Detail</a>
                    </td>
                  </tr>
                  <?php } ?>
                  </tbody>
    ...
    <div class="modal fade" id="modal-default">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <input type="text" class="form-control" placeholder="Nama Kegiatan" name="namakegiatan">
            </div>
            <div class="form-group">
            <label for="exampleFormControlTextarea1">Deskripsi Kegiatan</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" placeholder="Deskripsikan kegiatan" name="deskripsi"></textarea>
            </div>
            <div class="form-group">

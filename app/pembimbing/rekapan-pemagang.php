              ...
              <div class="card-body">
                <table id="example1" class="table table-hover">
                  ...
                  <tbody>
                    ...
                    $query = mysqli_query ($koneksi, "SELECT * FROM tb_laporan_harian WHERE id_pembimbing='{$_SESSION['id_pembimbing']}'");
                  ...
                  <tr>
                    ...
                    <td>
                      <a href= "detail-rekapanpemagang.php?id-laporan=<?= $row['id'];?>&id-pemagang=<?= $row['id_pemagang'] ?>" class="btn btn-sm btn-outline-info">Lihat</a>
                    </td>
                  </tr>
                  <?php } ?>
                </tbody>

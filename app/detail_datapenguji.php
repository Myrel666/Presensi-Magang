<?php 
    ...
    include('header.php');
     ...
     <?php 
    $id = $_GET['id'];
    $query = mysqli_query($koneksi,"SELECT * FROM tb_penguji WHERE id='$id'");
              ...
              <form method="get">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control disabled"  placeholder="Nama Lengkap" name='nama' value="<?php echo $view['nama_penguji']?>" disabled>
                ...
                <button type="button" onclick="goBack()" class="btn btn-info" style="margin: 7px">Tutup</button>
                </div>
              </form>
            </div>
            <!-- /.card -->
